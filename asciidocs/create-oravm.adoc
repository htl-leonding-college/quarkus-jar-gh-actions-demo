...
Enter file in which to save the key (/home/stuetz/.ssh/id_ecdsa):
Enter passphrase (empty for no passphrase):
Enter same passphrase again:
Your identification has been saved in /home/stuetz/.ssh/id_ecdsa
Your public key has been saved in /home/stuetz/.ssh/id_ecdsa.pub
The key fingerprint is:
SHA256:H3w6fdmGRYgZYjy6dUtL4+HSgJAKhqfKPaFLcISx5Rk stuetz@ubuntu-linux-22-04-desktop
